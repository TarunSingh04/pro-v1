...
const CompanyProfile = () => {
  ...
  const [companyName, setCompanyName] = useState("Impakter");
  const [companyRegistrationNumber, setCompanyRegistrationNumber] = useState("11045");
  ...
  const handleTextChange = (
    ...
    const handleCodeSelect = (code:any) => {
      ...
      setPhoneData(`${code} ${number}`); // Update phoneData with new code
    ...
    const handleNumberChange = (event:any) => {
      ...
      setPhoneData(`${selectedCode} ${number}`); // Combine with selected code
    };
    ...
    <div className={styles.companyProfile}>
      ...
      <div className={styles.companyInfocont}>
        <div className={styles.leftcont}>
          <div className={styles.wrapperInputBox2}>
            <p>Company Name</p>
            <input type="text" placeholder="Enter Company Name" disabled value={companyName}/>
          </div>
          <div className={styles.wrapperInputBox2}>
      ...
      <div className={styles.inputContainer}>
        ...
        />
          ...
          <div className={styles.wrapperInputBox1}>
            <p>Email</p>
            <input type="email" placeholder="Enter Email Address"  value={email} // Bind input value to state
      ...
      <div className={styles.companyInfocont2}>
        <div className={styles.leftcont}>
          ...
          />
          <div className={styles.wrapperInputBox1}>
            <input type="text" placeholder="Enter Street Address" value={streetAddress} // Bind input value to state
            onChange={handleStreetAddressChange}/>
          </div>
          <div className={styles.wrapperInputBox6}>
            <div className={styles.wrapperInputBox2}>
              <input type="text" placeholder="City" value={city} // Bind input value to state
            onChange={handleCityChange}/>
            </div>
            <div className={styles.wrapperInputBox2}>
              <input type="text" placeholder="Region" value={region} // Bind input value to state
          ...
          <div className={styles.wrapperInputBox1}>
            ...
            <input type="text" placeholder="Enter Date Established" value={dateEstablished} onChange={handleDateChange}/>
          </div>
        </div>
        <div className={styles.rightcont}>
          ...
          <div className={styles.wrapperInputBox4}>
            ...
            />
            <input type="text" placeholder="Facebook Link" value={facebookLink} onChange={handleFacebookLinkChange}/>
          </div>
          ...
          <div className={styles.wrapperInputBox4}>
            <Image
              ...
              className={styles.linkIcon}
            />
            <input type="text" placeholder="Twitter Link" value={twitterLink} onChange={handleTwitterLinkChange}/>
          </div>
          ...
          <div className={styles.wrapperInputBox4}>
            <Image
              ...
              className={styles.linkIcon}
            />
            <input type="text" placeholder="Linkedin Link" value={linkedinLink} onChange={handleLinkedLinkChange}/>
          </div>
          ...
          <div className={styles.wrapperInputBox4}>
            <Image
              ...
              className={styles.linkIcon}
            />
            <input type="text" placeholder="Video Link (Youtube/Vimeo)" value={videoLink} onChange={handleVideoLinkChange}/>
          </div>
      ...
      <div className={styles.companyInfocont2}>
        <div className={styles.leftcont}>
          ...
          <div className={styles.wrapperInputBox7}>
            <input type="text" placeholder="Name Of The Award" value={awards} onChange={handleAwardsChange}/>
            <select
              className={styles.select}
              value={awardsYear}
          ...
          <div className={styles.wrapperInputBox4}>
            <Image
              ...
              className={styles.linkIcon}
            />
            <input type="text" placeholder="Paste The Link Of The Award" value={awardsLink} onChange={handleAwardsLinkChange}/>
          </div>
          <p className={styles.socialHeader2}>Select Awards</p>
          <MultiSelect
            placeholder={"Select linked brands"}
            data={LinkedBrands}
            onChangeSelected={setLinkedBrands}
          />
        </div>
